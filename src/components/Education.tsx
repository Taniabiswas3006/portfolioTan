    ...
    <section id="education" className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="relative">
          {/* Vertical line */}
          <div className="absolute left-6 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-primary/60 via-secondary/40 to-transparent" />
              ...
              >
                ...
                >
                  <div className="group relative">
                    ...
                    <div className="relative glass-card p-6 md:p-8 bg-spaceDark/50 border-white/5 group-hover:border-primary/20 transition-all duration-500">
                      {/* Current badge */}
                      {item.current && (
                      ...
                      {/* Title */}
                      <h3 className="text-xl md:text-2xl font-bold text-white mb-3 font-poppins">
                        {item.title}
                      </h3>
